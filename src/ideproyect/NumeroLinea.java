	...
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	public final static float RIGHT = 1.0f;
        ...
        //Configuracion del borde,del numero de linea 
	private final static Border OUTER = new MatteBorder(0, 0, 0, 2, Color.BLUE);

	private final static int HEIGHT = Integer.MAX_VALUE - 1000000;

	//  Componente de texto este componente TextTextLineNumber esta sincronizado con 

	private JTextComponent component;

	//  Porpiedades que se pueden cambiar
	...
	//  Mantenga la información del historial para reducir la cantidad de veces que el componente 
